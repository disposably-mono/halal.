...
export function RowActions({
  ...
  const itemCls =
    "block w-full text-left px-[13px] py-[8px] text-[12px] text-white/70 hover:bg-white/6 focus-visible:bg-white/6 focus-visible:outline-hidden no-underline";
  ...
  return (
    <>
      <button
        ...
        disabled={isPending}
        onClick={() => setOpen((v) => !v)}
        className="rounded-[6px] border border-white/[0.07] px-[8px] py-[4px] text-white/40 hover:text-white/70 hover:border-white/12 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-gold/40 transition-all disabled:opacity-40"
      >
      ...
      {open &&
        ...
        createPortal(
          <div
            ...
            className="z-50 origin-top-right animate-dropdown-in overflow-hidden rounded-[9px] border border-white/10 bg-admin-surface py-[4px] shadow-xl"
          >
            ...
            {canLifecycle && (
              <>
                <div className="my-[4px] border-t border-white/6" />
                <button
                  type="button"
                  role="menuitem"
