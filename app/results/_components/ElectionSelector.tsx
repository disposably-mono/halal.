...
export function ElectionSelector({
  ...
  return (
    <section className="border-b border-white/8 bg-navy/20 px-4 py-3 sm:px-6">
      <div className="mx-auto flex max-w-3xl items-center justify-between gap-4">
        <button
          onClick={onPrev}
          disabled={!canPrev}
          className="rounded-sm border border-white/10 p-2 text-white/50 transition-all hover:border-gold/30 hover:text-gold focus-visible:border-gold/40 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-gold/30 disabled:cursor-not-allowed disabled:opacity-20"
        ...
        <div className="min-w-0 flex-1 text-center">
          ...
          <p className="mt-0.5 font-body text-xs text-white/35">
