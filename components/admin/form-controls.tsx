...
export const adminInputClass =
  "bg-white/4 border border-white/10 rounded-[8px] px-[11px] py-[8px] text-[13px] text-white/80 font-mono outline-hidden transition-colors focus:border-gold/50 focus:ring-2 focus:ring-gold/10 w-full scheme-dark disabled:opacity-40 disabled:cursor-not-allowed";
